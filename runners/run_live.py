...
def main():
    ...
    # Get configuration
    epics = cfg["symbols"]
    timeframe = cfg.get("timeframe", "5min")  # 5min default, 288 bars = 24h
    ...
    # Select active strategy from config (key is optional, defaults to moving_average)
    active_strategy_name = cfg.get("strategy", {}).get("name", "moving_average")
    ...
    while True:
        try:
            ...
            # Sleep between cycles — adaptive to symbol count
